...
std::map<std::string, unsigned int> VKCodes::vkCodeMap = {
    ...
    {"VK_LAUNCH_MEDIA_SELECT", 0xB5},  // Launch Media Select key
    {"VK_LAUNCH_APP1", 0xB6},  // Launch Application 1 key
    {"VK_LAUNCH_APP2", 0xB7},  // Launch Application 2 key
    {"VK_OEM_1", 0xBA},  // OEM 1 key
    {"VK_OEM_PLUS", 0xBB},  // OEM Plus key
    {"VK_OEM_COMMA", 0xBC},  // OEM Comma key
    {"VK_OEM_MINUS", 0xBD},  // OEM Minus key
    {"VK_OEM_PERIOD", 0xBE},  // OEM Period key
    {"VK_OEM_2", 0xBF},  // OEM 2 key
    {"VK_OEM_3", 0xC0},  // OEM 3 key
    {"VK_ABNT_C1", 0xC1},  // Portuguese Keyboard: Home key
    {"VK_ABNT_C2", 0xC2},  // Portuguese Keyboard: New key
    ...
    {"VK_PROCESSKEY", 0xE5},  // Process key
